...
- ~~工程无版本控制（无 `.git`），全过程改动无回滚能力~~ → **2026-09-16 已解决**（git 建仓 + 基线提交 `b2f0e67`；2026-09-17 已推送至 GitHub 公开仓库。详见 `Docs/IterationLogs/2026-09-16-建立版本控制基线.md` 与 `2026-09-17-建立远程仓库.md`）
